...
_GLASSES_SYSTEM_CONTEXT = (
    ...
    "  - Brevity is a TARGET, not a ceiling. If the task produced MULTIPLE items, "
    "results, or candidates (e.g. a list/scale pass over 2+ items), enumerate ALL "
    "of them — short bullets are fine. Never drop a result to stay under a length "
    "target. A complete short list beats an incomplete shorter one.\n"
