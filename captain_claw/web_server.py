...
COMMANDS: list[dict[str, str]] = [
    ...
    {"command": "/publish <folder> as \"<name>\"", "description": "Publish a VFS folder as a hosted site/app", "category": "Orchestrator"},
...
class WebServer:
    ...
    async def _topics_star(self, request: web.Request) -> web.Response:
    ...
    async def _topic_message_move(self, request: web.Request) -> web.Response:
        from captain_claw.web.rest_topics import move_message
        return await move_message(self, request)
