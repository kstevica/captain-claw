...
export function RunReport({
  session, vatraMode, truth, confidence, method, analysis, runs, runCost, subject, project,
  progress, subtasks, recompiling, onRecompile, onView, onFeedback,
  ...
  return (
    <div className="rounded-lg border border-zinc-800 bg-zinc-900/50">
      ...
      <div className="p-4">
        ...
        {activeTab === 'files' && <RunFilesPanel project={project} variant="tab" />}

        {/* Datastore tab — the tables the team built in the run's folder. */}
        {activeTab === 'datastore' && <RunDatastorePanel project={project} variant="tab" />}
