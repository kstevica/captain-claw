...
export type ViewMode = 'desktop' | 'quick-chat' | 'prompt-builder' | 'today' | 'workflow' | 'skills' | 'spawner' | 'forge' | 'library' | 'operations' | 'admin' | 'council' | 'basna' | 'dubina' | 'connections' | 'games' | 'gpu-cloud' | 'projects' | 'app' | 'code-app' | 'scheduler' | 'flows' | 'observatory' | 'autonomous-work' | 'vfs' | 'deep-memory' | 'agent-folders' | 'code' | 'hosting' | 'system' | 'browser-llm' | 'beings'
