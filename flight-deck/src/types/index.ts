...
export type ViewMode = 'desktop' | 'prompt-builder' | 'today' | 'workflow' | 'skills' | 'spawner' | 'forge' | 'operations' | 'admin' | 'council' | 'connections' | 'games' | 'gpu-cloud' | 'projects' | 'app' | 'code-app'
